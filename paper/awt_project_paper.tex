...
They no longer require large sums to deploy their services as well as don't need to be troubled with infrastructure maintenance issues, like under- or overprovisioning of resources, if an offered service exceeds or falls below expectations \cite{Fox}.
