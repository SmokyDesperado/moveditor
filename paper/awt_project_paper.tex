...
\begin{IEEEkeywords}
web UI, video and image stitching, DASH, SQS
\end{IEEEkeywords}

\section{Introduction}
Fraunhofer FOKUS something created a backend for video stitching...
...
z-index for better loading, playback-loop...
...
\section{Discussion}
SQS and FH backend are shit; a backend managing the request and providing an API would be better...
